...
Public Sub render()
    ...
    ' DESACTIVADO - Botones ahora en TileEngine_RenderScreen.bas
    ' If Not frmMain.IconBar Is Nothing Then
    '     Call frmMain.IconBar.Render
    ' End If
    
    ' Renderizar ventanas flotantes
    Call WindowManager_Render
