...
Public ViewportOffsetX As Single  ' Offset de centrado calculado (pixeles sobrantes / 2)
Public ViewportOffsetY As Single  ' Offset de centrado calculado (pixeles sobrantes / 2)
...
Public Sub Init_TileEngine()
    ...
    ' Calcular offset de centrado: pixeles sobrantes / 2
    ViewportOffsetX = (frmMain.renderer.ScaleWidth Mod 32) / 2
    ViewportOffsetY = (frmMain.renderer.ScaleHeight Mod 32) / 2
...
Sub ConvertCPtoTP(ByVal viewPortX As Integer, ByVal viewPortY As Integer, ByRef tX As Byte, ByRef tY As Byte)
    ...
    ' Compensar offset de centrado (el render suma ViewportOffset, el click lo resta)
    viewPortX = viewPortX - ViewportOffsetX
    viewPortY = viewPortY - ViewportOffsetY
