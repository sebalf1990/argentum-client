                ...
                Else
                    ...
                    If UsingSkill = magia Then
                        If ModoHechizos = BloqueoLanzar Then
                            SendSkill = IIf((mouseX >= frmMain.renderer.ScaleLeft And mouseX <= frmMain.renderer.ScaleWidth + frmMain.renderer.ScaleLeft And mouseY >= frmMain.renderer.ScaleTop And _
                                    mouseY <= frmMain.renderer.ScaleTop + frmMain.renderer.ScaleHeight), True, False)
                        ...
                        Else
                            If MainTimer.Check(TimersIndex.AttackSpell, False) Then
                                If MainTimer.Check(TimersIndex.CastSpell) Then
                                    SendSkill = IIf((mouseX >= frmMain.renderer.ScaleLeft And mouseX <= frmMain.renderer.ScaleWidth + frmMain.renderer.ScaleLeft And mouseY >= frmMain.renderer.ScaleTop _
                                            And mouseY <= frmMain.renderer.ScaleTop + frmMain.renderer.ScaleHeight), True, False)
                                    If Not SendSkill Then
                                        Exit Sub
                                    End If
                                    Call MainTimer.Restart(TimersIndex.CastAttack)
