...
Begin VB.Form frmMain 
   ...
   Begin VB.PictureBox panel 
      ...
      Begin VB.Image cmdMoverHechi 
         ...
         Index           =   1
         Left            =   3375
         MouseIcon       =   "frmMain.frx":59B0
         MousePointer    =   99  'Custom
         Picture         =   "frmMain.frx":5B02
         Tag             =   "0"
         Top             =   4260
         Visible         =   0   'False
         Width           =   315
...
Private Sub renderer_MouseUp(Button As Integer, Shift As Integer, x As Single, y As Single)
    ...
    Call FloatingWindow_HandleMouseUp
    clicX = x
    clicY = y
...
Private Sub renderer_MouseMove(Button As Integer, Shift As Integer, x As Single, y As Single)
    ...
    Call FloatingWindow_HandleMouseMove(CInt(x), CInt(y))
...
Private Sub renderer_MouseDown(Button As Integer, Shift As Integer, x As Single, y As Single)
    ...
    ' Check IconBar click first
    If Not IconBar Is Nothing Then
        If IconBar.HandleClick(CInt(x), CInt(y)) Then
            Exit Sub
        End If
    End If
    
    ' Check floating windows click
    If FloatingWindow_HandleMouseDown(CInt(x), CInt(y), Button) Then
        Exit Sub
    End If
...
Private Sub renderer_DblClick()
    ...
    ' Handle floating window double-click first
    If FloatingWindow_HandleDblClick(CInt(g_LastMouseX), CInt(g_LastMouseY)) Then
        Exit Sub
    End If
