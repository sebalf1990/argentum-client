...
Public Sub InitializeInventory()
    ...
    Set frmMain.IconBar = New clsIconBar
    ...
    Call frmMain.IconBar.Initialize(frmMain.renderer.ScaleWidth)
    
    ' Initialize Window Manager for floating windows
    Call WindowManager_Initialize(frmMain.renderer.ScaleWidth, frmMain.renderer.ScaleHeight)
